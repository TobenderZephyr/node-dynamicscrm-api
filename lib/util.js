...
try {
    ...
    request = function (opts, callback) {
        ...
        exec(NEW_NODE_PATH + ' ' + __dirname + '/proxy_requester.js ' + encoded, execOpts, function (err, stdout, stderr) {
          if (err) {
...
var Util = function (settings) {
    ...
    if (settings.crmRegion && typeof settings.crmRegion !== "string") throw new Error("'settings.crmRegion' property must be a string");
    ...
    var defaultUrlSuffix = settings.defaultUrlSuffix === false ? "" : ".api.crm.dynamics.com" ,
        ...
        organizationServiceEndpoint = (settings.useHttp ? "http://" : "https://") + hostname + ":" + settings.port + organizationPath,
        ...
        apiAssignMessage                = fs.readFileSync(__dirname + "/templates/api_assign.xml").toString(),
        apiAddToList                    = fs.readFileSync(__dirname + "/templates/api_addtolist.xml").toString(),
    ...
    */
    ...
    fetchEndpoints = function (cb) {
        ...
        request(options, function (err, res, body) {
            ...
            if (fault.length > 0) return cb(new DynamicsError(fault.toString(), body), null);
            ...
            if (location.length > 0) {
                ...
                request(opts, function (err, res, body) {
                    ...
                    if (faultImport.length > 0) return cb(new DynamicsError(faultImport.toString(), body), null);
    ...
    authenticateUsingFederation = function (authOptions, cb) {
        fetchEndpoints(function (err, wsdlInfo) {
            ...
            wstrustFlowOptions = {
                wstrustEndpoint: authOptions.wstrustEndpoint || identifier + "/2005/usernamemixed",
    ...
    this.Authenticate = function (options, cb) {
        kidoConnector.isHostAllowed(hostname, function (err, allowed) {
            ...
            options.wstrustEndpoint = options.wstrustEndpoint || settings.wstrustEndpoint;
    ...
    */
    this.RetrieveEntity = function (options, cb) {
        this.executePost(options, "Execute", apiExecuteMessage, serializer.toXmlRetrieveEntity(options), cb);
    }
    ...
    */
    this.RetrieveAttribute = function (options, cb) {
        this.executePost(options, "Execute", apiExecuteMessage, serializer.toXmlRetrieveAttribute(options), cb);
    }
    ...
    */
    ...
    this.Assign = function (options, cb) {
        this.executePost(options, "Execute", apiAssignMessage, serializer.toXmlAssign(options), cb);
    };
    ...
    this.AddToList = function (options, cb) {
        this.executePost(options, "Execute", apiAddToList, serializer.toXmlAddToList(options), cb);
    };    
