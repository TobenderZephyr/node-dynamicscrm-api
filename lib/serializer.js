    ...
    this.toXmlCreateUpdate= function(options)
    {
        ...
        if (options.Attributes) {
            var atts = options.Attributes.map(function(c) {
                ...
                return '<b:KeyValuePairOfstringanyType><c:key>'+ c.key + '</c:key><c:value  i:type="d:' + type + '" xmlns:d="' + ns + '">'+ c.value +'</c:value></b:KeyValuePairOfstringanyType>';
    ...
    */
    ...
    this.toXmlRetrieveMultiple = function(options)
    {
        ...
        if (options.ConditionExpression) {
            ...
            var values = options.ConditionExpression.Values.map(function(c){return "<c:anyType i:type=\"d:" + c.type + "\" xmlns:d=\"http://www.w3.org/2001/XMLSchema\">" + c.value + "</c:anyType>"});
