var Serializer = function () {
    ...
    */
    ...
    this.toXmlAddToList = function(options) {
        ...
        xml += '<b:guid>18f6316e-6bbf-e711-811d-5065f38a2b21</b:guid>';
        xml += '</c:value>';
        xml += '</b:KeyValuePairOfstringanyType>';
        ...
        // xml += '<c:key>ListId</c:key>';
        // xml += '<c:value i:type="b:guid">';
        // xml += '<b:guid>4EA85EA9-D866-E311-A406-B4B52F56EDF0</b:guid>'
        // xml += '</c:value>';
        // xml += '</b:KeyValuePairOfstringanyType>';
        
        // xml += '<b:KeyValuePairOfstringanyType>';
        // xml += '<c:key>MemberIds</c:key>';
        // xml += '<c:value i:type="b:ArrayOfguid">';
        // xml += '<b:guid>18f6316e-6bbf-e711-811d-5065f38a2b21</b:guid>';
        // xml += '</c:value>';
        // xml += '</b:KeyValuePairOfstringanyType>';
