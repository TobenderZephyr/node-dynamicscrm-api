var Serializer = function () {
  ...
  this.toXmlAssign = function (options) {
    ...
    if (options.Target) {
      ...
      xml +=
        '<b:LogicalName>' + options.Target.LogicalName + '</b:LogicalName>';
    ...
    if (options.Assignee) {
      ...
      xml +=
        '<b:LogicalName>' + options.Assignee.LogicalName + '</b:LogicalName>';
      xml += '<b:Name i:nil="true" />';
      xml += '</c:value>';
      xml += '</b:KeyValuePairOfstringanyType>';
    }
  ...
  /*
    {
        "ListId": "... dynamics guid ... ",
        "MemberIds": ["... dymnamics guid ...", "... dymnamics guid ..."]
    }
    */
  this.toXmlAddToList = function (options) {
    ...
    if (options.ListId) {
      ...
      xml +=
        '<c:value i:type="b:guid" xmlns:d="http://schemas.microsoft.com/2003/10/Serialization/">';
      xml += options.ListId;
      xml += '</c:value>';
      xml += '</b:KeyValuePairOfstringanyType>';
    }
    ...
    if (options.MemberIds) {
      ...
      options.MemberIds.map(function (id) {
        xml += '<d:guid>' + id + '</d:guid>';
      });
      xml += '</c:value>';
      xml += '</b:KeyValuePairOfstringanyType>';
    }
  ...
  this.toXmlRetrieveEntity = function (options) {
    var entityFilters =
      options.EntityFilters || 'Entity Attributes Relationships';
    ...
    var params = [
      {
        ...
        value: entityFilters,
        type: 'EntityFilters',
        ns: 'http://schemas.microsoft.com/xrm/2011/Metadata',
      },
      {
        key: 'MetadataId',
        value: metadataId,
  ...
  this.toXmlRetrieveMultiple = function (options) {
    ...
    if (options.ColumnSet) {
      ...
      xml +=
        '<b:ColumnSet><b:AllColumns>true</b:AllColumns><b:Columns/></b:ColumnSet>';
    }

    if (options.Criteria) {
      if (options.Criteria.Conditions) {
        if (options.Criteria.Conditions.FilterOperators) {
          var filters = options.Criteria.Conditions.FilterOperators.map(
            function (c) {
    ...
    if (options.ConditionExpression) {
      ...
      xml +=
        '<b:AttributeName>' +
        options.ConditionExpression.AttributeName +
        '</b:AttributeName>';
      xml +=
        '<b:Operator>' + options.ConditionExpression.Operator + '</b:Operator>';

      var values = options.ConditionExpression.Values.map(function (c) {
        return (
          '<c:anyType i:type="d:' +
          c.type +
    ...
    if (options.Orders) {
      ...
      for (var i = 0; i < options.Orders.length; i++) {
        ...
        xml +=
          '<b:OrderExpression><b:AttributeName>' +
          o.AttributeName +
          '</b:AttributeName>';
        xml +=
          '<b:OrderType>' +
          (o.OrderType || 'Ascending') +
          '</b:OrderType></b:OrderExpression>';
      }
      xml += '</b:Orders>';
    }
    ...
    if (pageInfo.PagingCookie === null) {
      ...
      xml +=
        '<b:PagingCookie>' +
        xmlentities(pageInfo.PagingCookie) +
        '</b:PagingCookie>';
    }
  ...
  this.toXmlRetrieve = function (options) {
    ...
    if (options.ColumnSet) {
      ...
      xml +=
        '<columnSet><b:AllColumns>true</b:AllColumns><b:Columns></b:Columns></columnSet>';
    }
